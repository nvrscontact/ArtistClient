...
*/
  ...
  return (
    <div>
     ...
     <button onClick={alternarMenu} className='flex items-center gap-3 cursor-pointer'>
    ...
    <div className='absolute right-0 top-14 z-20 bg-black/60 backdrop-blur-xl w-full inter-200 pr-2'> {idiomasDisponibles.map((idioma) => (  
        ...
        <section key={idioma.codigo} onClick={() => seleccionarIdioma(idioma.codigo)} className='flex flex-col justify-end cursor-pointer '>
